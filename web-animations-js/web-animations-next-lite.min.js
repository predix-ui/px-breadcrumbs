...
!function (a, b) {
  var c = {},
    ...
    function d(a) {
    ...
    }, b.AnimationTimeline.prototype = { getAnimations: function getAnimations() {
      ...
      Object.defineProperty(window.document, "timeline", { configurable: !0, get: function get() {
          return g;
        } });
    } catch (a) {}try {
    ...
    }, b.KeyframeEffect.prototype = { getFrames: function getFrames() {
    ...
    };var j = window.getComputedStyle;Object.defineProperty(window, "getComputedStyle", { configurable: !0, enumerable: !0, value: function value() {
    ...
    function d(a) {
      ...
      var c,
          ...
          i = null;h = a.normalizeTimingInput(h);var j = function j() {
    ...
    function d(a) {
      ...
      e.apply(this, arguments);
    }, e.prototype = { _isAncestor: function _isAncestor(a) {
        ...
        b.removeMulti(a);for (var c = 0; c < a.length; c++) {
          a[c]._parent = this;
        }
        ...
        for (var c = b ? "Cannot append an ancestor or self" : "Cannot prepend an ancestor or self", d = 0; d < a.length; d++) {
          if (this._isAncestor(a[d])) throw { type: DOMException.HIERARCHY_REQUEST_ERR, name: "HierarchyRequestError", message: c };
        ...
        b.removeMulti([this]);
      } }, window.SequenceEffect.prototype = Object.create(e.prototype), Object.defineProperty(window.SequenceEffect.prototype, "activeDuration", { get: function get() {
        var a = 0;return this.children.forEach(function (b) {
          a += d(b);
        }), Math.max(a, 0);
      } }), window.GroupEffect.prototype = Object.create(e.prototype), Object.defineProperty(window.GroupEffect.prototype, "activeDuration", { get: function get() {
        var a = 0;return this.children.forEach(function (b) {
          a = Math.max(a, d(b));
        }), a;
